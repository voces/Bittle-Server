...
let tester = new Tester([
    ...
    [{id: "setPermission", repo: "temp_1", user: "temp_3", role: "manager"}, {id: "setPermission", status: "closed"}, true],
    [{id: "setPermission", repo: "temp_1", user: "temp_3", role: "none"}, {id: "setPermission", status: "closed"}],
    [{id: "setPermission", repo: "temp_1", user: "temp_3", role: "none"}, {id: "setPermission", status: "failed", reason: "User does not have any permission."}],
    [{id: "setPermission", repo: "temp_1", user: "temp_3", role: "manager"}, {id: "setPermission", status: "closed"}, true],
    [{id: "deletePermission", repo: "temp_1", user: "temp_3"}, {id: "deletePermission", status: "closed"}],
    [{id: "deletePermission", repo: "temp_1", user: "temp_3"}, {id: "deletePermission", status: "failed", reason: "User does not have any permission."}],
    [{id: "logout"}, {id: "logout", status: "closed"}, true],
    ...
    [{id: "deleteFile", repo: "temp_1", file: "sample.txt"}, {id: "deleteFile", status: "failed", reason: "File does not exist."}],
    [{id: "deleteFile", repo: "temp_1", file: "magic.txt"}, {id: "deleteFile", status: "closed"}],
    ...
    [{id: "moveDirectory", repo: "temp_1", directory: "magic", newPath: "magic"}, {id: "moveDirectory", status: "failed", reason: "Directory does not exist."}],
    ...
    //Lines
    [{id: "insert", repo: "temp_1", file: "magic.txt", lineId: "0", col: 0, data: "Hello World"}, {id: "insert", status: "failed", reason: "File does not exist."}],
